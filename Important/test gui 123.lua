function initLibrary()
    ...
    function library:Load(opts)
        ...
        local color = options.color or Color3.fromRGB(19, 0, 255)
        ...
        utility.create("TextLabel", {
            ...
            TextSize = 14,
            TextColor3 = Color3.fromRGB(19, 0, 255),
            Text = name,
            ...
            function tabTypes:Section(opts)
                ...
                function sectionTypes:Toggle(opts)
                    ...
                    local function toggleToggle()
                        ...
                        local textColor = toggled and Color3.fromRGB(19, 0, 255) or Color3.fromRGB(180, 180, 180)
                        local gradientColor
                        if toggled then
                ...
                function sectionTypes:Dropdown(opts)
                    ...
                    local value = utility.create("TextLabel", {
                        ...
                        FontSize = Enum.FontSize.Size12,
                        TextSize = 12,
                        TextColor3 = (multiChoice and (#default > 0 and Color3.fromRGB(19, 0, 255) or Color3.fromRGB(180, 180, 180))) or default and Color3.fromRGB(19, 0, 255) or Color3.fromRGB(180, 180, 180),
                    ...
                    local function selectObj(obj, padding, bool)
                        ...
                        value.TextColor3 = bool and Color3.fromRGB(19, 0, 255) or Color3.fromRGB(180, 180, 180)
                    end
                        ...
                        option.MouseButton1Click:Connect(function()
                            if not multiChoice then
                                ...
                                if not table.find(chosen, opt) then
                                    ...
                                    value.TextColor3 = Color3.fromRGB(19, 0, 255)
                                    ...
                                    value.TextColor3 = #chosen > 0 and Color3.fromRGB(19, 0, 255) or Color3.fromRGB(180, 180, 180)
                ...
                function sectionTypes:ColorPicker(opts)
                    ...
                    local default = options.default or Color3.fromRGB(19, 0, 255)
                    local flag = options.flag
                    local callback = options.callback or function() end
