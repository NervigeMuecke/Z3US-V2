...
local Themes = {
	...
	Z3US = {
		Name = "Z3US",
		Accent = Color3.fromRGB(30, 20, 255),
		AcrylicMain = Color3.fromRGB(5, 5, 18),
		AcrylicBorder = Color3.fromRGB(25, 15, 120),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 0, 10), Color3.fromRGB(8, 5, 30)),
		AcrylicNoise = 0.97,
		TitleBarLine = Color3.fromRGB(30, 20, 140),
		Tab = Color3.fromRGB(55, 40, 200),
		Element = Color3.fromRGB(35, 25, 160),
		ElementBorder = Color3.fromRGB(0, 0, 12),
		InElementBorder = Color3.fromRGB(28, 18, 110),
		ElementTransparency = 0.91,
		ToggleSlider = Color3.fromRGB(50, 35, 210),
		ToggleToggled = Color3.fromRGB(10, 8, 40),
		SliderRail = Color3.fromRGB(45, 32, 195),
		DropdownFrame = Color3.fromRGB(60, 45, 220),
		DropdownHolder = Color3.fromRGB(8, 5, 28),
		DropdownBorder = Color3.fromRGB(18, 12, 85),
		DropdownOption = Color3.fromRGB(48, 34, 195),
		Keybind = Color3.fromRGB(48, 34, 195),
		Input = Color3.fromRGB(48, 34, 195),
		InputFocused = Color3.fromRGB(0, 0, 8),
		InputIndicator = Color3.fromRGB(70, 55, 235),
		InputIndicatorFocus = Color3.fromRGB(30, 20, 255),
		Dialog = Color3.fromRGB(8, 5, 28),
		DialogHolder = Color3.fromRGB(5, 3, 20),
		DialogHolderLine = Color3.fromRGB(4, 2, 16),
		DialogButton = Color3.fromRGB(8, 5, 28),
		DialogButtonBorder = Color3.fromRGB(32, 22, 130),
		DialogBorder = Color3.fromRGB(25, 16, 108),
		DialogInput = Color3.fromRGB(14, 9, 48),
		DialogInputLine = Color3.fromRGB(55, 40, 210),
		Text = Color3.fromRGB(200, 200, 255),
		SubText = Color3.fromRGB(110, 105, 190),
		Hover = Color3.fromRGB(48, 34, 195),
		HoverChange = 0.04
	},
	Dark = {
		Name = "Dark",
	...
	Void = {
		...
		AcrylicMain = Color3.fromRGB(8, 0, 12),
		AcrylicBorder = Color3.fromRGB(50, 0, 75),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 0, 18), Color3.fromRGB(14, 0, 22)),
		AcrylicNoise = 0.96,
		TitleBarLine = Color3.fromRGB(65, 0, 95),
		Tab = Color3.fromRGB(110, 10, 160),
		Element = Color3.fromRGB(85, 5, 130),
		ElementBorder = Color3.fromRGB(40, 0, 60),
		InElementBorder = Color3.fromRGB(60, 0, 90),
		ElementTransparency = 0.90,
		ToggleSlider = Color3.fromRGB(130, 15, 190),
		ToggleToggled = Color3.fromRGB(20, 0, 30),
		SliderRail = Color3.fromRGB(120, 10, 175),
		DropdownFrame = Color3.fromRGB(145, 20, 210),
		DropdownHolder = Color3.fromRGB(25, 0, 40),
		DropdownBorder = Color3.fromRGB(45, 0, 70),
		DropdownOption = Color3.fromRGB(120, 10, 175),
		Keybind = Color3.fromRGB(120, 10, 175),
		Input = Color3.fromRGB(120, 10, 175),
		InputFocused = Color3.fromRGB(8, 0, 12),
		InputIndicator = Color3.fromRGB(160, 30, 230),
		InputIndicatorFocus = Color3.fromRGB(180, 0, 255),
		Dialog = Color3.fromRGB(20, 0, 32),
		DialogHolder = Color3.fromRGB(15, 0, 24),
		DialogHolderLine = Color3.fromRGB(12, 0, 20),
		DialogButton = Color3.fromRGB(20, 0, 32),
		DialogButtonBorder = Color3.fromRGB(55, 0, 85),
		DialogBorder = Color3.fromRGB(48, 0, 72),
		DialogInput = Color3.fromRGB(30, 0, 46),
		DialogInputLine = Color3.fromRGB(140, 18, 200),
		Text = Color3.fromRGB(230, 200, 255),
		SubText = Color3.fromRGB(160, 130, 190),
		Hover = Color3.fromRGB(120, 10, 175),
		HoverChange = 0.04
	},
	Light = {
		Name = "Light",
	...
	Lava = {
		Name = "Lava",
		Accent = Color3.fromRGB(255, 90, 10),
		AcrylicMain = Color3.fromRGB(18, 8, 5),
		AcrylicBorder = Color3.fromRGB(80, 30, 10),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 10, 5), Color3.fromRGB(40, 15, 5)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(100, 40, 15),
		Tab = Color3.fromRGB(170, 65, 20),
		Element = Color3.fromRGB(140, 50, 15),
		ElementBorder = Color3.fromRGB(70, 25, 8),
		InElementBorder = Color3.fromRGB(100, 35, 12),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(200, 75, 20),
		ToggleToggled = Color3.fromRGB(40, 15, 5),
		SliderRail = Color3.fromRGB(190, 70, 18),
		DropdownFrame = Color3.fromRGB(210, 85, 25),
		DropdownHolder = Color3.fromRGB(55, 20, 8),
		DropdownBorder = Color3.fromRGB(75, 28, 10),
		DropdownOption = Color3.fromRGB(185, 68, 18),
		Keybind = Color3.fromRGB(185, 68, 18),
		Input = Color3.fromRGB(185, 68, 18),
		InputFocused = Color3.fromRGB(18, 8, 3),
		InputIndicator = Color3.fromRGB(230, 100, 30),
		InputIndicatorFocus = Color3.fromRGB(255, 90, 10),
		Dialog = Color3.fromRGB(55, 20, 8),
		DialogHolder = Color3.fromRGB(45, 16, 6),
		DialogHolderLine = Color3.fromRGB(38, 12, 5),
		DialogButton = Color3.fromRGB(55, 20, 8),
		DialogButtonBorder = Color3.fromRGB(100, 38, 14),
		DialogBorder = Color3.fromRGB(88, 33, 12),
		DialogInput = Color3.fromRGB(65, 25, 10),
		DialogInputLine = Color3.fromRGB(200, 78, 22),
		Text = Color3.fromRGB(255, 220, 200),
		SubText = Color3.fromRGB(200, 150, 120),
		Hover = Color3.fromRGB(185, 68, 18),
		HoverChange = 0.04
	},
	SoftCream = {
		Name = "SoftCream",
	...
	Sakura = {
		...
		AcrylicMain = Color3.fromRGB(255, 235, 242),
		AcrylicBorder = Color3.fromRGB(255, 190, 215),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 230, 240), Color3.fromRGB(255, 215, 232)),
		AcrylicNoise = 0.95,
		TitleBarLine = Color3.fromRGB(255, 175, 205),
		Tab = Color3.fromRGB(220, 100, 145),
		Element = Color3.fromRGB(255, 180, 210),
		ElementBorder = Color3.fromRGB(240, 155, 190),
		InElementBorder = Color3.fromRGB(255, 165, 200),
		ElementTransparency = 0.75,
		ToggleSlider = Color3.fromRGB(255, 140, 180),
		ToggleToggled = Color3.fromRGB(200, 80, 120),
		SliderRail = Color3.fromRGB(255, 160, 195),
		DropdownFrame = Color3.fromRGB(255, 200, 220),
		DropdownHolder = Color3.fromRGB(255, 220, 235),
		DropdownBorder = Color3.fromRGB(240, 155, 190),
		DropdownOption = Color3.fromRGB(255, 150, 185),
		Keybind = Color3.fromRGB(255, 155, 190),
		Input = Color3.fromRGB(255, 170, 205),
		InputFocused = Color3.fromRGB(200, 100, 140),
		InputIndicator = Color3.fromRGB(255, 210, 228),
		InputIndicatorFocus = Color3.fromRGB(255, 105, 160),
		Dialog = Color3.fromRGB(255, 225, 238),
		DialogHolder = Color3.fromRGB(255, 215, 232),
		DialogHolderLine = Color3.fromRGB(255, 205, 225),
		DialogButton = Color3.fromRGB(255, 230, 240),
		DialogButtonBorder = Color3.fromRGB(255, 175, 210),
		DialogBorder = Color3.fromRGB(255, 160, 200),
		DialogInput = Color3.fromRGB(255, 200, 222),
		DialogInputLine = Color3.fromRGB(255, 175, 210),
		Text = Color3.fromRGB(60, 20, 35),
		SubText = Color3.fromRGB(130, 60, 90),
		Hover = Color3.fromRGB(255, 165, 200),
		HoverChange = 0.03
	},
	Sapphire = {
		Name = "Sapphire",
