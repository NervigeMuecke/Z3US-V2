...
local Themes = {
	...
	Z3US = {
		Name = "Z3US",
		Accent = Color3.fromRGB(58, 45, 255),
		AcrylicMain = Color3.fromRGB(0, 0, 0),
		AcrylicBorder = Color3.fromRGB(35, 28, 155),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(4, 2, 22), Color3.fromRGB(10, 6, 42)),
		AcrylicNoise = 0.98,
		TitleBarLine = Color3.fromRGB(40, 30, 165),
		Tab = Color3.fromRGB(75, 62, 215),
		Element = Color3.fromRGB(22, 16, 95),
		ElementBorder = Color3.fromRGB(0, 0, 0),
		InElementBorder = Color3.fromRGB(38, 28, 140),
		ElementTransparency = 0.93,
		ToggleSlider = Color3.fromRGB(80, 68, 228),
		ToggleToggled = Color3.fromRGB(8, 6, 35),
		SliderRail = Color3.fromRGB(55, 44, 200),
		DropdownFrame = Color3.fromRGB(88, 75, 235),
		DropdownHolder = Color3.fromRGB(6, 4, 26),
		DropdownBorder = Color3.fromRGB(28, 20, 110),
		DropdownOption = Color3.fromRGB(65, 54, 210),
		Keybind = Color3.fromRGB(65, 54, 210),
		Input = Color3.fromRGB(22, 16, 95),
		InputFocused = Color3.fromRGB(0, 0, 5),
		InputIndicator = Color3.fromRGB(95, 82, 245),
		InputIndicatorFocus = Color3.fromRGB(58, 45, 255),
		Dialog = Color3.fromRGB(6, 4, 22),
		DialogHolder = Color3.fromRGB(3, 2, 14),
		DialogHolderLine = Color3.fromRGB(2, 1, 10),
		DialogButton = Color3.fromRGB(10, 7, 38),
		DialogButtonBorder = Color3.fromRGB(45, 35, 172),
		DialogBorder = Color3.fromRGB(34, 25, 138),
		DialogInput = Color3.fromRGB(16, 11, 60),
		DialogInputLine = Color3.fromRGB(72, 60, 220),
		Text = Color3.fromRGB(185, 185, 255),
		SubText = Color3.fromRGB(95, 88, 175),
		Hover = Color3.fromRGB(40, 30, 165),
		HoverChange = 0.05
	},
	Dark = {
		Name = "Dark",
