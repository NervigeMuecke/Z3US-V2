...
local Library do
    ...
    Library = {
        ...
        Folders = {
            Directory = "Z3US",
            Configs = "Z3US/Hypershot/Configs",
            Assets = "Z3US/Hypershot/Assets",
            Themes = "Z3US/Hypershot/Themes"
        },
    ...
    -- taken from https://github.com/deividcomsono/Obsidian/blob/main/Library.lua
    ...
    Library.Page = function(self, Data)
        ...
        local iconImage = Data.Icon and Library:GetCustomIcon(Data.Icon) or 
                        Data.icon and Library:GetCustomIcon(Data.icon)
        ...
        local Items = { } do
            Items["Inactive"] = Instances:Create("ImageButton", {
                ...
                AutoButtonColor = false,
                Name = "\0",
                Image = iconImage and iconImage.Url or "rbxassetid://109391165290124",
                ImageRectOffset = iconImage and iconImage.ImageRectOffset or Vector2.new(0, 0),
                ImageRectSize = iconImage and iconImage.ImageRectSize or Vector2.new(0, 0),
                BackgroundTransparency = 1,
